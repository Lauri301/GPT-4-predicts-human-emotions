...
gpt_data_all_average_path <- 'path/tettamanti_project/raitings/data/gpt_4-1_data/average/all_averages/output_average_10_files_1_2_3_4_5_6_7_8_9_10.csv'
human_data_batches_path <- 'path/tettamanti_project/raitings/data/human_data/data_csv'
average_corr_table_save_path <- 'path/tettamanti_project/raitings/data/human_data/average_corr_tables'
scatterplot_avgcorr_save_path <- 'path/tettamanti_project/raitings/analysis_gpt_4-1'
