...
regressor_dir = 'path/fmri_analysis/NAPS_fmri_gpt-4-1/regressors/gpt_reg';
first_level_dir = 'path/fmri_analysis/NAPS_fmri_gpt-4-1/first_level_gpt';
...
load(files{1});
for j = 1:length(features_gpt)-1
    feature = features_gpt{j}; % Extract the string from the cell
    
    tmp_folder = sprintf('path/fmri_analysis/NAPS_fmri_gpt-4-1/regressors/feature_models_gpt/%s',feature);
