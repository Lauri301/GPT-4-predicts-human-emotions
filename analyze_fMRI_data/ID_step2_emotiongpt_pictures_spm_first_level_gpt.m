%% EmotionGPT: First level analyses of the localizer fMRI data with gpt derived regressors
...
regressor_dir = 'path/naps/regressors/gpt_reg';
first_level_dir = 'path/naps/fmri_analysis/first_level/gpt';
...
for j = 1:length(features_gpt)-1
    ...
    tmp_folder = sprintf('path/naps/tmp2/%s',feature);
    ...
    for i = 1:size(subjects,1)
        ...
        reg_file = sprintf('%s/pictures_%s_gpt_regressors.mat',regressor_dir,sub);
