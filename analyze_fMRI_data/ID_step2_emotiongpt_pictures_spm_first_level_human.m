...
% Directories
preproc_dir = 'path/fmri_analysis/NAPS_fmri_gpt-4-turbo/preProg';
regressor_dir = 'path/fmri_analysis/NAPS_fmri_gpt-4-1/regressors/human_reg';
first_level_dir = 'path/fmri_analysis/NAPS_fmri_gpt-4-1/first_level_human';
brainmask = 'path/fmri_analysis/localizer/megafmri_localizer_gm_mask_2mm.nii';
...
for j = 1:length(features_human)-1
    ...
    tmp_folder = sprintf('path/fmri_analysis/NAPS_fmri_gpt-4-1/regressors/feature_models_human/%s',feature);
