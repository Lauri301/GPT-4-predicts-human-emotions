...
regressor_dir = 'path/fmri_analysis/VD1_fmri_gpt-4-1/regressors/gpt_reg';
first_level_dir = 'path/fmri_analysis/VD1_fmri_gpt-4-1/first_level_gpt';
...
for j = 1:length(features)
    ...
    tmp_folder = sprintf('path/fmri_analysis/VD1_fmri_gpt-4-1/regressors/feature_models_gpt/%s',feature);
