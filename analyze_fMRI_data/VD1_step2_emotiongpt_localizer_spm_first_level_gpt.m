...
regressor_dir = 'path/fmri_analysis/Megaperception_fmri/regressors/gpt_reg';
first_level_dir = 'path/fmri_analysis/Megaperception_fmri/first_level_gpt';
...
for j = 1:length(features)
    ...
    tmp_folder = sprintf('path/fmri_analysis/Megaperception_fmri/regressors/feature_models_gpt/%s',feature);
