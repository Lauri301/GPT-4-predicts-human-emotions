...
% Directories
preproc_dir = 'path/fmri_analysis/localizer/preprocessed';
regressor_dir = 'path/fmri_analysis/Megaperception_fmri_gpt_4-1/regressors/human_reg';
first_level_dir = 'path/fmri_analysis/Megaperception_fmri_gpt_4-1/first_level_human';
...
for j = 1:length(features)
    ...
    tmp_folder = sprintf('path/fmri_analysis/Megaperception_fmri_gpt_4-1/regressors/feature_models_human/%s',feature);
