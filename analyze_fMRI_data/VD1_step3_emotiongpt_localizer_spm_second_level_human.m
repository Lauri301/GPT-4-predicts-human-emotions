%% EmotionGPT: Second level analyses of localizer fMRI data with human derived regressors
% Batch the second level analysis over eatch emotion
%
% Severi Santavirta, Yuhang Wu,Lauri Suominen 1.2.2026

% Define the directories
base_indir = 'path/fmri_analysis/localizer/first_level/human';
base_output = 'path/fmri_analysis/localizer/second_level/human';
