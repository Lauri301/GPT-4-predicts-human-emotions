%% EmotionGPT: Second level analyses of localizer fMRI data with lowlevel (audiovisual confounds) regressors
% Batch the second level analysis over lowlevel features
%
% Severi Santavirta, Yuhang Wu,Lauri Suominen 1.2.2026

% Define the directories
base_indir = 'path/fmri_analysis/localizer/first_level/lowlevel_confounds';
base_output = 'path/fmri_analysis/localizer/second_level/lowlevel_confounds';
