%% EmotionGPT: Contrast the GPT based results with the low-level results
...
lowlevel_output = 'path/fmri_analysis/localizer/second_level/lowlevel_confounds';
feature_output = 'path/fmri_analysis/localizer/second_level/gpt';
