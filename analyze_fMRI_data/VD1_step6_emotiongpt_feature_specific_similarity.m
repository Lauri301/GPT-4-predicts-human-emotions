%% EmotionGPT:: Compare the emotion specific fMRI results for emotional evaluation between GPT-4 and humans
...
% Directories
basedir = 'path/fmri_analysis/localizer/second_level'; % CHANGE
brainmask = 'path/megafmri_localizer_gm_mask_3mm.nii';

human_dir = fullfile(basedir, '/human');
gpt_dir = fullfile(basedir, '/gpt');
...
for i = 1:n_emotions
    ...
    unc0001 = sprintf('spmT_0001_unc0001_pos_%s_lowlevel_contrasted.nii', emotion);
    FWE005 = sprintf('spmT_0001_FWE005_pos_%s_lowlevel_contrasted.nii', emotion);
...
filename = 'localizer_lowlevel_contrasted_similarity_table.csv';
