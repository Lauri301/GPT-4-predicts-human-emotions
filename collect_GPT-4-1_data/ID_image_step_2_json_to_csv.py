...
# Basic path
basic_path = Path('path/data/ID/ratings/data/gpt_4-1_data') # CHANGE

# Image source folder and next round target folder
source_folder = 'path/data/ID/stimulus' # CHANGE
target_folder = f'path/data/ID/stimulus/stimulus_round_{round_number}_{extra_round}' # CHANGE
