"""
This is the first step in the process of collecting image data and include GROK API.
...
output_folder_base = 'path/data/ID/ratings/data/grok_data/dataset' #CHANGE
