"""
This is the thirth step in collecting video data. 
This step generates a CSV file from the json file created in the previous step.
It also checks for missing ratings for videos and copies them to a new folder for an extra run of step two.
...
# Basic path
basic_path = Path('path/data/VD2/ratings/data/grok_data') # CHANGE
